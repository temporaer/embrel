...
#if 0 
int GetMatInd(Matrix a, int xi, int yi)
{
	return yi*a.nx+xi;
}


double GetMatEl(Matrix a, int xi, int yi) 
{
	return a.dat[GetMatInd(a,xi,yi)];
}
#endif
...
/* Return the distance between the columns of the given matrices */
double  mat_dist_2(Matrix m1, Matrix m2, Matrix res, double *px0, double *py0)
{
	int i1,i2,k;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	Z = mat_dist_2(phi_tr,psi_tr,pxy,px0,py0);

	/*	Z = mat_el_exp_sum(pxy.dat, pxy_size,px0,py0); */
