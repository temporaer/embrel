function [phi,psi,lik] = logemb_grad_dim(pxy0,dim_list,params)
%
%
%
...
for curr_dim = dim_list
  for(i_repeat=1:params.max_repeats)
    ...
    cg_params.pxy0 = pxy0;
    cg_params.collapse = params.collapse;
    
    opts = -1*zeros(1,9);
%    x = conj_grad('logemb_grad_fast',cg_params,x0,opts);
    x = conj_grad('logemb_grad_collapse',cg_params,x0,opts);
